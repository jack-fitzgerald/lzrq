...
gmmq_BS2_test <- function(T.fn,tau,Y,X,Z,Z.excl,Lambda,Lambda.derivative,beta.hat,beta0, Itilde=NULL, Itilde.deriv=NULL, h, structure=c('iid','ts','cluster'),cluster.X.col=NULL,VERBOSE=FALSE,h.adj=1,BREP=99,BLAG=NA) {
